...
#ifndef NOTESAPP_SWIFT_H
#define NOTESAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NotesApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8NotesApp7AddTask")
...
SWIFT_CLASS("_TtC8NotesApp11AppDelegate")
...
typedef SWIFT_ENUM(NSInteger, DatePickerStyle, closed) {
  DatePickerStyleWheel = 0,
  DatePickerStyleInline = 1,
  DatePickerStyleCompact = 2,
};
...
SWIFT_CLASS("_TtC8NotesApp8NoteCell")
@interface NoteCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified btnCheckbox;
...
SWIFT_CLASS("_TtC8NotesApp13SceneDelegate")
...
@interface TaskList (SWIFT_EXTENSION(NotesApp))
- (IBAction)actionOk:(id _Nonnull)sender;
- (IBAction)actionCancel:(id _Nonnull)sender;
@end

@class NSIndexPath;

@interface TaskList (SWIFT_EXTENSION(NotesApp)) <UITableViewDataSource, UITableViewDelegate>
